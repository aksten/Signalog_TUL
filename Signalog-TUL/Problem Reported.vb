...
Public Class Problem_Reported
    Dim lnklabel(0 To 4) As String
    Dim probrepdesc(0 To 5) As String
    Dim probrepcode(0 To 5) As String
    Dim rowcount As Integer

    Private Sub Problem_Reported_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If Field_Maintenance_Activity_Report.CallFromReport = True Then
            Field_Maintenance_Activity_Report.CallFromReport = False
            Field_Maintenance_Activity_Report.RepProbEdit = False
        Else
            Trouble_Report.RepProbEdit = False
        End If
    End Sub

    Private Sub Problem_Reported_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Height = SUB1.Location.Y + SUB1.Size.Height + 50
        Dim j As Integer
        For j = 0 To 5
            probrepdesc(j) = String.Empty
            probrepcode(j) = String.Empty
        Next j
        For j = 0 To 4
        ...
        If Trouble_Report.RepProbEdit = True Or Field_Maintenance_Activity_Report.RepProbEdit = True Then   'Load previous selections and memo (if memo exists)
            Dim s1 As String
            Dim s2 As String
            Dim s3 As String
            Dim s4 As String
            ...
            If Trouble_Report.RepProbEdit = True Then
                i = Trouble_Report.ReportedProblemGrid.CurrentRow.Index
                s1 = Trouble_Report.Prob_Rep_Code(i, 0)  'Loading activity codes
                s2 = Trouble_Report.Prob_Rep_Code(i, 1)
                s3 = Trouble_Report.Prob_Rep_Code(i, 2)
                s4 = Trouble_Report.Prob_Rep_Code(i, 3)
                s5 = Trouble_Report.Prob_Rep_Code(i, 4)
                s6 = Trouble_Report.Prob_Rep_Code(i, 5)
            ElseIf Field_Maintenance_Activity_Report.RepProbEdit = True Then
            ...
            If memo = True And Trouble_Report.RepProbEdit = True Then
                MemoBox.Text = Trouble_Report.Prob_Rep_Code(Trouble_Report.ReportedProblemGrid.CurrentRow.Index, 6)
            End If
    ...
    Private Sub SUB1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB1.SelectedIndexChanged
        ...
        Dim i As Integer
        For i = 0 To 5
            probrepdesc(i) = String.Empty
            probrepcode(i) = String.Empty
        Next i
        If SUB1.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            probrepdesc(0) = SUB1.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = "REPT PROB" Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = probrepdesc(0) Then
                        probrepcode(0) = SignalogDataSet.ASUB.Rows(i)(4)
    ...
    Private Sub SUB2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB2.SelectedIndexChanged
        ...
        If SUB2.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            probrepdesc(1) = SUB2.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(0) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = probrepdesc(1) Then
                        probrepcode(1) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB3_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB3.SelectedIndexChanged
        ...
        If SUB3.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            probrepdesc(2) = SUB3.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(1) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = probrepdesc(2) Then
                        probrepcode(2) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB4.SelectedIndexChanged
        ...
        If SUB4.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            probrepdesc(3) = SUB4.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(2) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = probrepdesc(3) Then
                        probrepcode(3) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB5_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB5.SelectedIndexChanged
        ...
        If SUB5.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            probrepdesc(4) = SUB5.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(3) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = probrepdesc(4) Then
                        probrepcode(4) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB6_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB6.SelectedIndexChanged
        probrepdesc(5) = SUB6.SelectedValue
        For i = 0 To rowcount - 1
            If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(4) Then
                If SignalogDataSet.ASUB.Rows(i)(2) = probrepdesc(5) Then
                    probrepcode(5) = SignalogDataSet.ASUB.Rows(i)(4)
                End If
            End If
        Next i
    ...
    Private Sub Submit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit.Click
        ...
        If Field_Maintenance_Activity_Report.CallFromReport = True Then   'Called from Field Maintenance Activity Report
            ...
            For k = 0 To 5
                If probrepdesc(k) <> String.Empty Then
                    If k = 5 Then
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += probrepdesc(k)
                    ElseIf probrepdesc(k + 1) = String.Empty Then
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += probrepdesc(k)
                    Else
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += probrepdesc(k) & ",  "
                    End If
                End If
                If probrepdesc(k) <> String.Empty Then
                    Field_Maintenance_Activity_Report.Activity_Code(Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Index, k) = probrepcode(k)
                Else
                ...
                End If
            Next k
            Field_Maintenance_Activity_Report.Activity_Code(Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Index, 6) = 1   'set ACTCODE
            Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Selected = False

        Else   'Called from Trouble Report
            Trouble_Report.ReportedProblemGrid.BeginEdit(True)
            Trouble_Report.ReportedProblemGrid.EditingControl.Text = ""

            For k = 0 To 5
                If probrepdesc(k) <> String.Empty Then
                    If k = 5 Then
                        Trouble_Report.ReportedProblemGrid.EditingControl.Text += probrepdesc(k)
                    ElseIf probrepdesc(k + 1) = String.Empty Then
                        Trouble_Report.ReportedProblemGrid.EditingControl.Text += probrepdesc(k)
                    Else
                        Trouble_Report.ReportedProblemGrid.EditingControl.Text += probrepdesc(k) & ",  "
                ...
                End If
                If probrepdesc(k) <> String.Empty Then
                    Trouble_Report.Prob_Rep_Code(Trouble_Report.ReportedProblemGrid.CurrentRow.Index, k) = probrepcode(k)
                Else
                    Trouble_Report.Prob_Rep_Code(Trouble_Report.ReportedProblemGrid.CurrentRow.Index, k) = String.Empty
                End If
            Next k

            If MemoBox.Visible = True And MemoBox.Text <> "" Then
                Trouble_Report.Prob_Rep_Code(Trouble_Report.ReportedProblemGrid.CurrentRow.Index, 6) = MemoBox.Text
                Trouble_Report.ReportedProblemGrid.EditingControl.Text += ",  " & MemoBox.Text
            End If

            Trouble_Report.ReportedProblemGrid.EndEdit()
            Trouble_Report.ReportedProblemGrid.CurrentRow.Selected = False
        End If
        Me.Close()
    End Sub
