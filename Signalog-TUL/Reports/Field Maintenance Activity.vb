...
Public Class Field_Maintenance_Activity
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Field Maintenance Activity.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Signalog.Field Maintenance Activity.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Report_Period() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedField_Maintenance_Activity
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Field_Maintenance_Activity = New Field_Maintenance_Activity()
        rpt.Site = Me.Site
        Return rpt
    End Function
