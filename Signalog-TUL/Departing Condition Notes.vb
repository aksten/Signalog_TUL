...
Public Class Departing_Condition_Notes
    Dim lnklabel(0 To 4) As String
    Dim depcondesc(0 To 5) As String
    Dim depconcode(0 To 5) As String
    Dim rowcount As Integer

    Private Sub Departing_Condition_Notes_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If Field_Maintenance_Activity_Report.CallFromReport = True Then
            Field_Maintenance_Activity_Report.CallFromReport = False
            Field_Maintenance_Activity_Report.DepConEdit = False
        Else
            Trouble_Report.DepConEdit = False
        End If
    End Sub
    
    Private Sub Departing_Condition_Notes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Height = SUB1.Location.Y + SUB1.Size.Height + 50
        Dim j As Integer
        For j = 0 To 5
            depcondesc(j) = String.Empty
            depconcode(j) = String.Empty
        Next j
        For j = 0 To 4
        ...
        If Trouble_Report.DepConEdit = True Or Field_Maintenance_Activity_Report.DepConEdit = True Then   'Load previous selections and memo (if memo exists)
            ...
            Dim i As Integer
            If Trouble_Report.DepConEdit = True Then
                i = Trouble_Report.DepartingConditionNotesGrid.CurrentRow.Index
                s1 = Trouble_Report.Dep_Con_Code(i, 0)  'Loading activity codes
                s2 = Trouble_Report.Dep_Con_Code(i, 1)
                s3 = Trouble_Report.Dep_Con_Code(i, 2)
                s4 = Trouble_Report.Dep_Con_Code(i, 3)
                s5 = Trouble_Report.Dep_Con_Code(i, 4)
                s6 = Trouble_Report.Dep_Con_Code(i, 5)
            ElseIf Field_Maintenance_Activity_Report.DepConEdit = True Then
            ...
            If memo = True And Trouble_Report.DepConEdit = True Then
                MemoBox.Text = Trouble_Report.Dep_Con_Code(Trouble_Report.DepartingConditionNotesGrid.CurrentRow.Index, 6)
            End If
    ...
    Private Sub SUB1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB1.SelectedIndexChanged
        ...
        Dim i As Integer
        For i = 0 To 5
            depcondesc(i) = String.Empty
            depconcode(i) = String.Empty
        Next i
        If SUB1.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            depcondesc(0) = SUB1.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = "DEPT COND" Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = depcondesc(0) Then
                        depconcode(0) = SignalogDataSet.ASUB.Rows(i)(4)
    ...
    Private Sub SUB2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB2.SelectedIndexChanged
        ...
        If SUB2.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            depcondesc(1) = SUB2.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(0) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = depcondesc(1) Then
                        depconcode(1) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB3_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB3.SelectedIndexChanged
        ...
        If SUB3.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            depcondesc(2) = SUB3.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(1) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = depcondesc(2) Then
                        depconcode(2) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB4.SelectedIndexChanged
        ...
        If SUB4.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            depcondesc(3) = SUB4.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(2) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = depcondesc(3) Then
                        depconcode(3) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB5_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB5.SelectedIndexChanged
        ...
        If SUB5.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            depcondesc(4) = SUB5.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(3) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = depcondesc(4) Then
                        depconcode(4) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB6_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB6.SelectedIndexChanged
        depcondesc(5) = SUB6.SelectedValue
        For i = 0 To rowcount - 1
            If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(4) Then
                If SignalogDataSet.ASUB.Rows(i)(2) = depcondesc(5) Then
                    depconcode(5) = SignalogDataSet.ASUB.Rows(i)(4)
                End If
            End If
        Next i
    ...
    Private Sub Submit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit.Click
        ...
        If Field_Maintenance_Activity_Report.CallFromReport = True Then   'Called from Field Maintenance Activity Report
            ...
            For k = 0 To 5
                If depcondesc(k) <> String.Empty Then
                    If k = 5 Then
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += depcondesc(k)
                    ElseIf depcondesc(k + 1) = String.Empty Then
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += depcondesc(k)
                    Else
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += depcondesc(k) & ",  "
                    End If
                End If
                If depcondesc(k) <> String.Empty Then
                    Field_Maintenance_Activity_Report.Activity_Code(Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Index, k) = depconcode(k)
                Else
                ...
                End If
            Next k
            Field_Maintenance_Activity_Report.Activity_Code(Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Index, 6) = 5   'set ACTCODE
            Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Selected = False

        Else   'Called from Trouble Report
            Trouble_Report.DepartingConditionNotesGrid.BeginEdit(True)
            Trouble_Report.DepartingConditionNotesGrid.EditingControl.Text = ""

            For k = 0 To 5
                If depcondesc(k) <> String.Empty Then
                    If k = 5 Then
                        Trouble_Report.DepartingConditionNotesGrid.EditingControl.Text += depcondesc(k)
                    ElseIf depcondesc(k + 1) = String.Empty Then
                        Trouble_Report.DepartingConditionNotesGrid.EditingControl.Text += depcondesc(k)
                    Else
                        Trouble_Report.DepartingConditionNotesGrid.EditingControl.Text += depcondesc(k) & ",  "
                ...
                End If
                If depcondesc(k) <> String.Empty Then
                    Trouble_Report.Dep_Con_Code(Trouble_Report.DepartingConditionNotesGrid.CurrentRow.Index, k) = depconcode(k)
                Else
                    Trouble_Report.Dep_Con_Code(Trouble_Report.DepartingConditionNotesGrid.CurrentRow.Index, k) = String.Empty
                End If
            Next k

            If MemoBox.Visible = True And MemoBox.Text <> "" Then
                Trouble_Report.Dep_Con_Code(Trouble_Report.DepartingConditionNotesGrid.CurrentRow.Index, 6) = MemoBox.Text
                Trouble_Report.DepartingConditionNotesGrid.EditingControl.Text += ",  " & MemoBox.Text
            End If

            Trouble_Report.DepartingConditionNotesGrid.EndEdit()
            Trouble_Report.DepartingConditionNotesGrid.CurrentRow.Selected = False
        End If
        Me.Close()
    End Sub
End Class