...
Public Class Deferred_Action
    Dim lnklabel(0 To 4) As String
    Dim defactdesc(0 To 5) As String
    Dim defactcode(0 To 5) As String
    Dim rowcount As Integer

    Private Sub Deferred_Action_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        If Field_Maintenance_Activity_Report.CallFromReport = True Then
            Field_Maintenance_Activity_Report.CallFromReport = False
            Field_Maintenance_Activity_Report.DefActEdit = False
        Else
            Trouble_Report.DefActEdit = False
        End If
    End Sub

    Private Sub Deferred_Action_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Height = SUB1.Location.Y + SUB1.Size.Height + 50
        Dim j As Integer
        For j = 0 To 5
            defactdesc(j) = String.Empty
            defactcode(j) = String.Empty
        Next j
        For j = 0 To 4
        ...
        If Trouble_Report.DefActEdit = True Or Field_Maintenance_Activity_Report.DefActEdit = True Then   'Load previous selections and memo (if memo exists)
            ...
            Dim i As Integer
            If Trouble_Report.DefActEdit = True Then
                i = Trouble_Report.DeferredActionGrid.CurrentRow.Index
                s1 = Trouble_Report.Def_Act_Code(i, 0)  'Loading activity codes
                s2 = Trouble_Report.Def_Act_Code(i, 1)
                s3 = Trouble_Report.Def_Act_Code(i, 2)
                s4 = Trouble_Report.Def_Act_Code(i, 3)
                s5 = Trouble_Report.Def_Act_Code(i, 4)
                s6 = Trouble_Report.Def_Act_Code(i, 5)
            ElseIf Field_Maintenance_Activity_Report.DefActEdit = True Then
            ...
            If memo = True And Trouble_Report.DefActEdit = True Then
                MemoBox.Text = Trouble_Report.Def_Act_Code(Trouble_Report.DeferredActionGrid.CurrentRow.Index, 6)
            End If
    ...
    Private Sub SUB1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB1.SelectedIndexChanged
        ...
        Dim i As Integer
        For i = 0 To 5
            defactdesc(i) = String.Empty
            defactcode(i) = String.Empty
        Next i
        If SUB1.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            defactdesc(0) = SUB1.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = "ACTN DEFR" Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = defactdesc(0) Then
                        defactcode(0) = SignalogDataSet.ASUB.Rows(i)(4)
    ...
    Private Sub SUB2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB2.SelectedIndexChanged
        ...
        If SUB2.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            defactdesc(1) = SUB2.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(0) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = defactdesc(1) Then
                        defactcode(1) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB3_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB3.SelectedIndexChanged
        ...
        If SUB3.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            defactdesc(2) = SUB3.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(1) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = defactdesc(2) Then
                        defactcode(2) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB4.SelectedIndexChanged
        ...
        If SUB4.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            defactdesc(3) = SUB4.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(2) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = defactdesc(3) Then
                        defactcode(3) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB5_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB5.SelectedIndexChanged
        ...
        If SUB5.SelectedValue = String.Empty Then
            ...
            SUB6.Visible = False
        Else
            defactdesc(4) = SUB5.SelectedValue
            For i = 0 To rowcount - 1
                If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(3) Then
                    If SignalogDataSet.ASUB.Rows(i)(2) = defactdesc(4) Then
                        defactcode(4) = SignalogDataSet.ASUB.Rows(i)(4)
                        Try  'lnklanbel coukd be null
    ...
    Private Sub SUB6_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SUB6.SelectedIndexChanged
        defactdesc(5) = SUB6.SelectedValue
        For i = 0 To rowcount - 1
            If SignalogDataSet.ASUB.Rows(i)(0) = lnklabel(4) Then
                If SignalogDataSet.ASUB.Rows(i)(2) = defactdesc(5) Then
                    defactcode(5) = SignalogDataSet.ASUB.Rows(i)(4)
                End If
            End If
        Next i
    ...
    Private Sub Submit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Submit.Click
        ...
        If Field_Maintenance_Activity_Report.CallFromReport = True Then   'Called from Field Maintenance Activity Report
            ...
            For k = 0 To 5
                If defactdesc(k) <> String.Empty Then
                    If k = 5 Then
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += defactdesc(k)
                    ElseIf defactdesc(k + 1) = String.Empty Then
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += defactdesc(k)
                    Else
                        Field_Maintenance_Activity_Report.ActivityGrid.CurrentCell.Value += defactdesc(k) & ",  "
                    End If
                End If
                If defactdesc(k) <> String.Empty Then
                    Field_Maintenance_Activity_Report.Activity_Code(Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Index, k) = defactcode(k)
                Else
                ...
                End If
            Next k
            Field_Maintenance_Activity_Report.Activity_Code(Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Index, 6) = 4   'set ACTCODE
            Field_Maintenance_Activity_Report.ActivityGrid.CurrentRow.Selected = False

        Else   'Called from Trouble Report
            Trouble_Report.DeferredActionGrid.BeginEdit(True)
            Trouble_Report.DeferredActionGrid.EditingControl.Text = ""

            For k = 0 To 5
                If defactdesc(k) <> String.Empty Then
                    If k = 5 Then
                        Trouble_Report.DeferredActionGrid.EditingControl.Text += defactdesc(k)
                    ElseIf defactdesc(k + 1) = String.Empty Then
                        Trouble_Report.DeferredActionGrid.EditingControl.Text += defactdesc(k)
                    Else
                        Trouble_Report.DeferredActionGrid.EditingControl.Text += defactdesc(k) & ",  "
                ...
                End If
                If defactdesc(k) <> String.Empty Then
                    Trouble_Report.Def_Act_Code(Trouble_Report.DeferredActionGrid.CurrentRow.Index, k) = defactcode(k)
                Else
                    Trouble_Report.Def_Act_Code(Trouble_Report.DeferredActionGrid.CurrentRow.Index, k) = String.Empty
                End If
            Next k

            If MemoBox.Visible = True And MemoBox.Text <> "" Then
                Trouble_Report.Def_Act_Code(Trouble_Report.DeferredActionGrid.CurrentRow.Index, 6) = MemoBox.Text
                Trouble_Report.DeferredActionGrid.EditingControl.Text += ",  " & MemoBox.Text
            End If

            Trouble_Report.DeferredActionGrid.EndEdit()
            Trouble_Report.DeferredActionGrid.CurrentRow.Selected = False
        End If
        Me.Close()
    End Sub
End Class